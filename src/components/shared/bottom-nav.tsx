...
export function BottomNav() {
  ...
  return (
    <nav className="bottom-nav supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto grid h-16 max-h-[var(--footer-height)] grid-cols-5 items-center px-0.5">
        {navItems.map((item) => {
