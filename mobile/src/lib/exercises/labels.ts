...
// Chip order matches the web library (src/components/exercises/exercise-library-list.tsx).
...
// Label maps copied from the web app's src/lib/exercises/labels.ts.
...
export const MECHANICS_LABELS: LabelMap = {
  ...
  ISOLATION: { en: "Isolation", ru: "Изолирующее" },
};
...
export const TAG_LABELS: LabelMap = {
  ...
  MOTOR: { en: "Motor control", ru: "Координация" },
